            ...
            formContainer = (
                <>
                    ...
                    />} */}
                            ...
                            >
                                <img
                                    src="https://res.cloudinary.com/djnhrvjyf/image/upload/v1595890712/change-prof-picture_mvdjme.svg"/>
                            </button>
                        </div>
                    </div>
                ...
                <div className="settings-wrapper">
                    <div>
                        <div className="content-settings">
                            <div className="navigation-settings"  style={{minHeight: '100vh'}}>
                                <Link class="category-settings active-settings" to="/settings">
                                    ...
                                    <div className="category__content-settings">
                                        <p>Your profile</p>
